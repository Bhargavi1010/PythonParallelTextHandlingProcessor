...
Input (File / Manual) ↓ Data Cleaning ↓ Chunk Division ↓ Parallel Processing Engine ↓ Sentiment Analysis ↓ Database Storage ↓ Search / Dashboard / Visualization
...
Input: "good bad worst"

Output: Positive: 1 Negative: 2 Score: -1 Sentiment: Negative
...
Mode| Performance Sequential| Slower Parallel| Faster ⚡
...
streamlit/ │── app.py │── processor.py │── parallel_engine.py │── chunk_manager.py │── sentiment_rules.py │── db_manager.py │── database.py │── csv_exporter.py │── main.py │── dataset.csv │── empty.csv
